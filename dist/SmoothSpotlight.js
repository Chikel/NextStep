...
const SmoothSpotlight = ({ x, y, width, height, padding = 30, radius = 20, shadowOpacity = 0.6, }) => {
    ...
    return (_jsx("div", { style: {
            ...
            pointerEvents: "none",
                                    ...
                                    rx: radius,
                                    ry: radius,
                                }, transition: { duration: 0.4, ease: "easeInOut" }, fill: "black" })] }) }), _jsx("rect", { width: "100%", height: "100%", fill: `rgba(0, 0, 0, ${shadowOpacity})`, mask: "url(#smooth-spotlight-mask)" })] }) }));
};
